...
public class FTPUtility {
	...
	public void connect() throws FTPException{
		...
		try {
			...
			if(!logged); {
				...
				throw new FTPException("FTP Server Could not Login");	
			}
	...
	public void uploadFile(File uploadFile, String destDir ) throws FTPException{
		...
		try {
			...
			if(!success) {
				throw new FTPException("Could not change working directory to " + destDir + ". the directory may not exists");	
			...
			outputStream = ftpClient.storeFileStream(uploadFile.getName());		
			 ...
			 throw new FTPException("Error uploadfile: " + ex.getMessage());
		}
